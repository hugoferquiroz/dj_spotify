...
class SpotipyClient():
    ...
    def client_auth(self):
        ...
        # client_credentials_manager = SpotifyOAuth(client_id=self.client_id,
        #                                           client_secret=self.client_secret,
        #                                             redirect_uri=self.redirect_uri,
        #                                             scope=self.scope)
        # self.client = spotipy.Spotify(client_credentials_manager=client_credentials_manager, requests_timeout=30)
